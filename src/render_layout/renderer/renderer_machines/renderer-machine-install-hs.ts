...
class RendererMachineInstallHS extends RendererMachineContainer {
    ...
    getContainerSize(viewBox: ViewBoxType) {
        switch (viewBox) {
            case ViewBoxType.H_W_M_1536:
                return { width: 25, height: 25 } // Loader-specific dimensions
            case ViewBoxType.H_W_L_1080:
                return { width: 25, height: 25 } // Larger loader for bigger viewport
            default:
...
export default RendererMachineInstallHS
