...
class RendererMachineInstallSocket extends RendererMachineContainer {
    ...
    getContainerSize(viewBox: ViewBoxType) {
        switch (viewBox) {
            ...
            case ViewBoxType.H_W_L_1080:
                return { width: 20, height: 20 } // Larger loader for bigger viewport
            default:
...
export default RendererMachineInstallSocket
